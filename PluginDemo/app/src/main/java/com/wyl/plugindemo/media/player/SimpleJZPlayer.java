package com.wyl.plugindemo.media.player;
...
public class SimpleJZPlayer extends JzvdStd {
    ...
    public void onStateError() {
        super.onStateError();
        LogUtils.e(TAG, "onStateError: ");
    }

    @Override
    public void onStateNormal() {
        LogUtils.e(TAG, "onStateNormal: ");
        super.onStateNormal();
    }
    ...
    public void onScreenStateChanged(int screenState) {
        LogUtils.e(TAG, "onScreenStateChanged: ");
        super.onScreenStateChanged(screenState);
    }

    @Override
    public void onStatePause() {
        LogUtils.e(TAG, "onStatePause: ");
        super.onStatePause();
    }

    @Override
    public void onStateAutoComplete() {
        LogUtils.e(TAG, "onStateAutoComplete: ");
    ...
    public void onStatePreparing() {
        LogUtils.e(TAG, "onStatePreparing: ");
        super.onStatePreparing();
    }

    @Override
    public void onStatePlaying() {
        LogUtils.e(TAG, "onStatePlaying: ");
